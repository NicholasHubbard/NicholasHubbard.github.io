    ...
    const renderIconMenu = (
        ...
        >
            ...
            <NavLink to="" style={
                ...
                <MenuItem onClick={handleIconClose}>Abilities</MenuItem>
            </NavLink>
        </Menu>
    );
    ...
    return (
        <div className={classes.grow}>
            <AppBar position="fixed" style={
                {background: 'black', display: 'block', marginBottom: '1em'}}>
                <Toolbar>
                    <Avatar src={TitleIcon} style={{marginLeft: '2em', marginRight: '0.5em'}}/>
                    ...
                    <div className={classes.sectionDesktop}>
                        <IconButton aria-label="" color="inherit" className={classes.highlight}>
                                <Facebook />
                        </IconButton>
                        <IconButton aria-label="" color="inherit" className={classes.highlight}>
                                <Twitter />
                        </IconButton>
                        <IconButton aria-label="" color="inherit" className={classes.highlight} style={{marginRight: '1em'}}>
                                <Instagram />
                        </IconButton>
                        <IconButton
                            edge="end"
                            ...
                            color="inherit"
                        >
                            <Avatar src={UserImage} style={{marginRight: '1em'}}/>
                        </IconButton>
                    </div>
